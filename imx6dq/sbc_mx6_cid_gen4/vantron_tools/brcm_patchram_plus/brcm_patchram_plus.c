...
proc_patchram()
{
	...
	printf("cmd: HCI_Download_Minidriver\n" );
	...
	if (tosleep) {
		printf("Sleep %dus before downloading...\n", tosleep);
		usleep(tosleep);
	}
