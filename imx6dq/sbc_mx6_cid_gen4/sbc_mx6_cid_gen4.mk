...
# Overrides
PRODUCT_NAME := sbc_mx6_cid_gen4
PRODUCT_DEVICE := sbc_mx6_cid_gen4
...
PRODUCT_COPY_FILES += \
    ...
    device/fsl/imx6dq/sbc_mx6_cid_gen4/prebuilt/bootanimation.zip:system/media/bootanimation.zip
...
# SBC-MX6-CID-GEN4 Hardware HAL libs.
PRODUCT_PACKAGES += \
	sensors.SBC_MX6_CID_GEN4	\
	gps.default
...
PRODUCT_COPY_FILES += \
        device/fsl/imx6dq/sbc_mx6_cid_gen4/tools/eepromtool_zkw:system/bin/eepromtool_zkw
